...
var validarInputs = function(){
	...
	if (elementos.email.value !== elementos.email2.value) {
		elementos.email.value = "";
		elementos.email2.value = "";
		elementos.email.className = elementos.email.className + " error";
		elementos.email2.className = elementos.email2.className + " error";
	} else {
		elementos.email.className = elementos.email.className.replace(" error", "");
		elementos.email2.className = elementos.email2.className.replace(" error", "");
	}
